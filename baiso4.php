...
if (isset($_REQUEST["addBook"])) {
   ...
   //$content = $id . "#" . $price . "#" . $title . "#" . $author . "#" . $year;
    Book::addToFile($id, $title, $price, $author, $year);
...
$lsFromFile = Book::getListFile($keyWord);
?>
            ...
            foreach ($lsFromFile as $key => $value) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- modal editBook -->
                        <div class="modal fade" id="editBook<?php echo $value->id ?>"  tabindex=" -1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form class="form-horizontal">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name='id_edit<?php echo $value->id?>' class="btn btn-primary">Save changes</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
